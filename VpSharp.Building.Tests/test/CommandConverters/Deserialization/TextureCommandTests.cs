...
internal sealed class TextureCommandTests
{
    ...
    {
        const string source = "create texture stone1";
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(action.Create.Commands[0], Is.InstanceOf<TextureCommand>());
    ...
    {
        const string source = "create texture stone1 mask=awb8m";
        VirtualParadiseAction action = ActionSerializer.Deserialize(source);
    ...
    {
        const string source = "create texture stone1 tag=1";
        VirtualParadiseAction action = ActionSerializer.Deserialize(source);
    ...
    {
        const string source = "create texture stone1 tag=1 mask=awb8m";
        VirtualParadiseAction action = ActionSerializer.Deserialize(source);
